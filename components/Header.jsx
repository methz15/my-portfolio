...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      >
        <Image src={assets.profile_img} alt='' className='w-40 aspect-square object-cover rounded-full'/>
      </motion.div>
      <motion.h3 
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            Hello! I'm Methma Hewavitharana<Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
    <motion.h1 
    initial={{y: -30, opacity: 0}}
    whileInView={{y: 0, opacity: 1}}
    transition={{duration: 0.8, delay: 0.5}}
    className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
        Software quality assurance engineer. </motion.h1>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            href="/Methma-resume.pdf" download 
